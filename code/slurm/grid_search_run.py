...
@click.option('--slurm-output-dir', help='Where to save the output', default=SLURM_OUTPUT_DIR, show_default=True)
...
@click.option('--mem', help='How much memory will each job need (MB).', default=10000, show_default=True)
...
def run(input_csv, output_dir, slurm_output_dir, epochs, dry, mem, timeout,
        shuffle, l_rate):
